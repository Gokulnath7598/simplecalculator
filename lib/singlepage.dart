...
class _SinglepageState extends State<Singlepage> {
  ...
  Widget textview({required double i, required double j, required String equation}) {
    return Expanded(
      child: Container(
        ...
        Expanded(
          child: Column(
            children: [
              ...
              textview(i:5, j:20,equation: equation),
              textview(i:5, j:25,equation: result),
            ],
          ),
        ),
        // portraitbutton(),
    ...
    return Column(
      children: [
        Expanded(
          child: Column(
            children: [
              textview(i:10, j:30,equation: equation),
              textview(i:10, j:50,equation: result),
            ],
          ),
        ),
        portraitbutton(),
